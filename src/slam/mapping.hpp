...
public:
    ...
    */
    void updateMap(const lidar_t& scan, const pose_xyt_t& pre_pose, const pose_xyt_t& cur_pose, OccupancyGrid& map);
    void rayCastBreshenham(const pose_xyt_t& pose, double z, double theta, OccupancyGrid& map);
