...
public:
    ...
    */
    ...
    // bool CompartParticleWeight(const particle_t& p1, const particle_t& p2);
    
private:
    // PoseTrace  poseTrace_;
    ...
    // struct CompartParticleWeight { 
    //     bool operator()(particle_t const &a, particle_t const &b) const noexcept { 
